...
DAMAGE_MESSAGE_FRAMES = 10
DAMAGE_MESSAGE_COLOUR = (255,0,0)
DAMAGE_MESSAGE_FLOAT_AMOUNT = HEALTHBAR_FLOAT_AMOUNT + 12
DAMAGE_MESSAGE_FLOAT_DOWN_AMOUNT = TILE_HEIGHT
DAMAGE_MESSAGE_WIGGLE = 2
...
BUTTON_PRESS_SIMULATION_COOLDOWN = 5
